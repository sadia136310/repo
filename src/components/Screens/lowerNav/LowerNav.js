...
const LowerNav = () => {
    ...
    return (
      ...
      <div className='cover'></div>
        <div className='h-fit w-full bg-teal-900 flex flex-row justify-center px-6 uppercase nav-media'>
            
          {/* <div className='h-12 text-sm font-bold text-white px-6 uppercase nav-item' onMouseOver={handleOpen} onMouseLeave={handleClose}> */}
          <div className='h-12 text-sm font-bold text-white px-6 uppercase nav-item categories-button' onMouseEnter={handleOpen} onMouseLeave={handleClose}>
            {/* <span>Categories <span className='gt-symb'>&gt;</span></span> */}
            <div className='nav-item-container'>
              <span className>Categories </span>
              <div className='icon-container'>
                <iconify-icon inline icon="material-symbols:keyboard-arrow-down" width="25" height="25" flip={isActive?"vertical":""} onClick={handleClick}></iconify-icon>
              </div>
            </div>
          </div>
        ...
        <div className='columns- p-14 gap-20 cat-container' style={{display: openCategories ? 'flex' : 'none', position: 'absolute', backgroundColor: 'white'}} onMouseEnter = {handleOpen} onMouseLeave={handleClose}>
