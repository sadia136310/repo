        ...
        <div>
            ...
            <div className='flex items-center justify-between border-b border-gray-300 py-2 lg:mx-48 sm:mx-2 md:mx-2'>
                <div className='flex mx-4 items-center'>
                    ...
                    <h4 className='text-md font-semibold'>1 Photo Brithday Wish Photo Frame 8 inch by 7 inch</h4>
                    <p className='font-semibold'><del className='text-gray-400'>₹399.00</del> ₹229.00</p>
                    <p>December 18,2022</p>
                    </div>
                </div>
                <div>
                    <button className='bg-teal-900 py-2 px-4 text-white font-semibold rounded-3xl'>ADD TO CART</button>
                </div>
            </div>
            <div className='flex items-center justify-between border-b border-gray-300 py-2 lg:mx-48 sm:mx-2 md:mx-2'>
                <div className='flex mx-4 items-center'>
            ...
            <div className='flex items-center py-2 lg:mx-48 sm:mx-2 md:mx-2 mt-6'>
                ...
                <input className='rounded-full px-4 py-2 border border-gray-400' type="text" ref={textAreaRef}
                 value='http://localhost:3000/wishlist'/>
                 {
                document.queryCommandSupported('copy') &&
                <div>
                <button onClick={copyToClipboard} className='bg-teal-900 py-2 px-6 ml-4 text-white font-semibold rounded-3xl'>COPY</button>
                {copySuccess}
                </div>
                 }
            </div>
